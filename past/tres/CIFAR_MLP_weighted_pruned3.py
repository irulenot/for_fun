...
# Training loop
def train(model, optimizer, criterion, train_loader, device, epoch, not_pruned):
    model.train()
    train_losses = []
...
for epoch in range(1, num_epochs + 1):
    train_loss = train(model, optimizer, criterion, train_loader, device, epoch, not_pruned)
...
plt.legend()
plt.savefig('loss3.png')  # Save the figure
plt.show()
...
plt.savefig('accuracy3.png')  # Save the figure
plt.show()
